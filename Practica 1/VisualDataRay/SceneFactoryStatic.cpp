...
SceneFactoryStatic::SceneFactoryStatic()
{

}
//color = 0.5f*vec3(2+normal.x,2+normal.y,2+normal.z);
Scene *SceneFactoryStatic::getScene(string nomfitxer, ObjectFactory::OBJECT_TYPES t) {
    Scene *s = new Scene();
    ...
    */
    ...
    LightVolumetric *lV = new LightVolumetric(vec3(-3.0,6.0,0.0));
